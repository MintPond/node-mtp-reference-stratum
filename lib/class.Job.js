...
function Job(args) {
    ...
    const difficulty = parseFloat((mtp.POW_LIMIT / targetBn.toNumber()).toFixed(9));
    const difficultyAdj = difficulty;
    ...
    Object.defineProperties(this, {
         ...
         * @type {number}
         */
        difficulty: { value: difficulty, enumerable: true },

        /**
         * The adjusted network difficulty of the Job.
         * @type {number}
         */
