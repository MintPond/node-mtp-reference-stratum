...
function Coinbase(args) {
    ...
    const signatureBuf = buffers.serializeString(args.signature);
    ...
    function _createCoinbase1() {
        ...
        const inputScriptLen = inputScript.length + extraNonceSize + signatureBuf.length;
